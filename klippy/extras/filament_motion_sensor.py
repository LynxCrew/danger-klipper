...
class EncoderSensor:
    ...
    def _handle_ready(self):
        ...
        self.runout_helper.note_filament_present(is_filament_present=True)
    ...
    def _extruder_pos_update_event(self, eventtime):
        ...
        self.runout_helper.note_filament_present(
            eventtime=eventtime,
            is_filament_present=extruder_pos < self.filament_runout_pos,
        )
    ...
    def encoder_event(self, eventtime, state):
        if self.extruder is not None:
            ...
            self.runout_helper.note_filament_present(
                eventtime=eventtime, is_filament_present=True
            )
    ...
    def reset(self):
        self._update_filament_runout_pos()
        self.runout_helper.note_filament_present(
            eventtime=self.reactor.monotonic(), is_filament_present=True
        )
